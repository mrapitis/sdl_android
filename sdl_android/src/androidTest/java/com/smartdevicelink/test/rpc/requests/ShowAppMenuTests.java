 ...
 * {@link com.smartdevicelink.rpc.ShowAppMenu}
 */
public class ShowAppMenuTests extends BaseRpcTests{
    ...
    protected JSONObject getExpectedParameters(int sdlVersion){
        ...
        try{
            result.put(ShowAppMenu.KEY_MENU_ID, Test.GENERAL_INT);
    ...
    public void testRpcValues () {       	
    	// Test Values
    	int          testMenuID      = ( (ShowAppMenu) msg ).getMenuId();
    ...
    public void testJsonConstructor () {
		...
		try {
			...
			assertEquals(Test.MATCH, JsonUtils.readIntegerFromJsonObject(parameters, ShowAppMenu.KEY_MENU_ID), cmd.getMenuId());
