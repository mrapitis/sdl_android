...
public class RegisterAppInterface extends RPCRequest {
	 ...
	 * @param languageDesired a Language Enumeration
	 * @param hmiDisplayLanguageDesired
	 * @param shortAppID a String value representing the the first 10 non "-" characters of the "fullAppID"<br>
	 * @param fullAppID a String value representing a unique ID, which an app will be given when approved <br>
	 *            <b>Notes: </b>Maxlength = 100
	 */
	public RegisterAppInterface(@NonNull SdlMsgVersion syncMsgVersion, @NonNull String appName, @NonNull Boolean isMediaApplication,
								@NonNull Language languageDesired, @NonNull Language hmiDisplayLanguageDesired, @NonNull String shortAppID, @NonNull String fullAppID) {
		this();
		setSdlMsgVersion(syncMsgVersion);
		setAppName(appName);
		setIsMediaApplication(isMediaApplication);
	 ...
	 *         will be given when approved, when <KEY_FULL_APP_ID> is also present, this
	 *            value should represent the the first 10 non "-" characters of the <KEY_FULL_APP_ID>
	 * @since SmartDeviceLink 2.0
	 */
	 ...
	 *            given when approved, when <KEY_FULL_APP_ID> is also present, this
	 *            value should represent the the first 10 non "-" characters of the <KEY_FULL_APP_ID>
	 *            <p></p>
	 *            <b>Notes: </b>Maxlength = 100
	 * @since SmartDeviceLink 2.0
	 ...
	 *
	 * @param fullAppID
	 *            a String value representing a unique UUID App ID, which an app will be
	 *            given when approved
	 *            <p></p>
	 *            <b>Notes: </b>Maxlength = 100
	 * @since SmartDeviceLink 2.0
